...
class FileUploader
{
    ...
    public static function resize($filename, $width = null, $height = null, $destination = null, $crop = false, $quality = 90, $rotation = 0)
    {
      ...
      default:
        ...
        imagecopyresampled(
      $dest, $source, isset($crop['newWidth']) ? $crop['left'] : 0, isset($crop['newHeight']) ? $crop['top'] : 0, ! isset($crop['newWidth']) ? $crop['left'] : 0, ! isset($crop['newHeight']) ? $crop['top'] : 0, isset($crop['newWidth']) ? $crop['newWidth'] : $width, isset($crop['newHeight']) ? $crop['newHeight'] : $height, $crop['width'], $crop['height']
    );
